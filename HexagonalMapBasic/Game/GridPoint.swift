...
extension GridPoint {
    ...
    func distance(towards point: GridPoint) -> Int {
    ...
    func angle(towards point: GridPoint) -> Float {
    ...
    /**
     ...
     north: 90.0
     */
    func direction(towards point: GridPoint) -> GridPointDirection {
    ...
    func adjacentPoints(of corner: GridPointCorner) -> [GridPoint] {
